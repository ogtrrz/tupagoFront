    ...
    return (
      <Container maxWidth="md" sx={{ py: 4 }}>
        ...
        <Typography variant="body1" paragraph>
          Esta aplicación web permite a los usuarios generar códigos QR para pagos,
          consultar el estado de sus transacciones y recibir actualizaciones en
          tiempo real sobre sus pagos realizados mediante QR o teléfonos móviles.
          Es compatible con dispositivos de escritorio y móviles, ofreciendo una
        ...
        <Typography variant="body1" paragraph>
          (El texto introductorio anterior ya cubre esta sección, pero se mantiene el
          encabezado para la estructura solicitada.)
        </Typography>
        ...
        <List dense>
          <ListItem>
            <ListItemText
              primary="✅ Generación de Códigos QR: Los usuarios pueden crear códigos QR personalizados para pagos."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="✅ Consulta de Estado de Pagos: Acceso en tiempo real al estado de cada transacción."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="✅ Historial de Pagos: Registro completo de todas las transacciones realizadas."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="✅ Notificaciones en Tiempo Real: Alertas sobre pagos recibidos o rechazados."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="✅ Acceso Multiplataforma: Disponible en navegadores de escritorio y móviles sin necesidad de instalación."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="✅ Seguridad Avanzada: Cifrado de extremo a extremo y autenticación de dos factores."
            />
          </ListItem>
        </List>
        ...
        <Typography variant="body2" paragraph>
          Un panel interactivo muestra información en vivo sobre pagos recibidos, pendientes
          y rechazados, permitiendo a los usuarios gestionar sus transacciones de manera
          eficiente.
        </Typography>
        ...
        <List dense>
          <ListItem>
            <ListItemText
              primary="Frontend: React.js / Vue.js para una interfaz moderna y rápida."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="Backend: Node.js con Express o Python con Django/Flask."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="Base de Datos: PostgreSQL / MongoDB para almacenamiento eficiente."
            />
          </ListItem>
          <ListItem>
            <ListItemText
          ...
          <ListItem>
            <ListItemText
              primary="WebSockets: Para actualizaciones en tiempo real sin recargar la página."
            />
          </ListItem>
        </List>
        ...
        <List dense>
          ...
          <ListItem>
            <ListItemText
              primary="Compartir el código QR con el cliente o usuario final."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="El cliente realiza el pago mediante su app bancaria o billetera digital."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="El sistema recibe la confirmación de pago en tiempo real a través de un callback."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="Se actualiza el estado del pago automáticamente en el panel de control."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="El usuario recibe una notificación con los detalles del pago."
            />
          </ListItem>
        </List>
        ...
        <Typography variant="body1" paragraph>
          Esta aplicación web proporciona una solución completa para la generación,
          consulta y monitoreo de pagos QR y telefónicos en tiempo real, con una
          interfaz intuitiva, segura y accesible desde cualquier dispositivo. Su
          integración con APIs de pago y notificaciones en tiempo real la hace ideal
          para cualquier empresa que desee optimizar sus procesos de cobro.
        </Typography>
        <Typography variant="body1" paragraph>
