    ...
    return (
      <Container maxWidth="md" sx={{ py: 4 }}>
        ...
        <List dense>
          ...
          <ListItem>
            <ListItemText
              primary="Se muestra la información del pago en la aplicación (monto, destinatario, detalles)."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="El usuario confirma el pago y la transacción se procesa en segundos."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="Tanto el comercio como el usuario reciben una notificación de pago exitoso."
            />
          </ListItem>
        </List>
        ...
        <List dense>
          <ListItem>
            <ListItemText
              primary="El usuario abre su aplicación de pagos y selecciona 'Generar QR'."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="Introduce el monto y muestra el código QR en su pantalla."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="El comercio escanea el QR con su sistema de pago o aplicación."
            />
          </ListItem>
          <ListItem>
            <ListItemText
        ...
        <Typography variant="body2" paragraph>
          ...
          completar su pago escaneando un código QR en la tienda web o recibiéndolo
          por correo electrónico.
        </Typography>
        <List dense>
          <ListItem>
            <ListItemText
              primary="Al realizar una compra, el usuario selecciona pago por QR."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="La tienda genera un código QR único con los detalles del pago."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="El usuario escanea el QR y la aplicación de pagos procesa la transacción."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="Se envía confirmación tanto al comprador como al vendedor."
            />
          </ListItem>
        </List>
        ...
        <List dense>
          <ListItem>
            <ListItemText
              primary="El vendedor genera una factura digital con un código QR."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="El cliente recibe la factura por correo y escanea el QR."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="El pago se procesa de inmediato y se genera una confirmación automática."
            />
          </ListItem>
        </List>
        ...
        <List dense>
          ...
          <ListItem>
            <ListItemText
              primary="✅ Mayor seguridad: No se comparten datos bancarios directamente con el comercio."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="✅ Reducción de costos: Comisiones más bajas y sin terminales físicas costosas."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="✅ Accesible para cualquier tipo de negocio: Ideal para grandes y pequeños comercios."
            />
          </ListItem>
          <ListItem>
            <ListItemText
              primary="✅ Ideal para transacciones sin contacto: Menos riesgo de transmisión de enfermedades."
            />
          </ListItem>
          <ListItem>
            <ListItemText
        ...
        <List dense>
          ...
          <ListItem>
            <ListItemText
              primary="📌 Restaurantes y cafeterías: Pagar desde la mesa con un QR en el menú o la cuenta."
            />
          </ListItem>
          <ListItem>
            <ListItemText
          ...
          <ListItem>
            <ListItemText
              primary="📌 Eventos y espectáculos: Vender entradas y validar accesos con QR."
            />
          </ListItem>
          <ListItem>
            <ListItemText
